...
var skel = function ()
{
    var e = "config", t = "breakpoints", n = "iterate", r = "stateId", i = "elements", s = "getElementsByClassName",
            o = "stateElements", u = "getElementsByTagName", a = !1, f = "length", l = "parentNode", c = null, h = "gutters",
            p = "insertBefore", d = "push", v = " 0 0 ", m = "getCachedElement", g = "className", y = "!important", b = "object",
            w = "cacheNewElement", E = "newInline", S = "grid", x = "config_breakpoint", T = "orientationChange", N = "locations",
            C = "parseMeasurement", k = "createElement", L = "match", A = "newElement", O = "deviceType",
            M = "padding-top:0!important", _ = "substring", D = !0, P = "viewport", H = "cache", B = "_skel_isReversed",
            j = "}", F = "head", I = "containers", q = "vars", R = "indexOf", U = "replace", z = "padding-top:",
            W = "matchesMedia", X = "extend", V = "events", $ = "isArray", J = "onorientationchange",
            K = ":first-child>:first-child {", Q = "DOMReady", G = "getComputedStyle", Y = "addEventListener",
            Z = "^head", et = "{display:none!important}", tt = "padding:", nt = "registerLocation", rt = "hasOwnProperty",
            it = "defaults", st = "documentElement", ot = "IEVersion", ut = "attachElements", at = "horizontal", ft = "plugins",
            lt = "attachElement", ct = "DOMContentLoaded", ht = "text/css", pt = "_skel_attach", dt = "initial-scale=1",
            vt = "states", mt = "firstChild", gt = ":first-child>*{", yt = "placeholder", bt = "removeEventListener",
            wt = ">*{", Et = "(min-width: ", St = ".row", xt = "resize", Tt = "media", Nt = "applyRowTransforms",
            Ct = "attached", kt = "vertical", Lt = "normalize", At = "change", Ot = ".row.uniform", Mt = "html",
            _t = "collapse", Dt = "forceDefaultState", Pt = "_skel_placeholder", Ht = "nextSibling", Bt = "min-height",
            jt = "max-height", Ft = "querySelectorAll", It = "prototype", qt = "max-width", Rt = "innerHTML",
            Ut = "min-width", zt = "domready", Wt = "android", Xt = ".\\3$1 ", Vt = "priority", $t = "readyState",
            Jt = "onresize", Kt = "isStatic", Qt = "href", Gt =
            {
                breakpoints: [], breakpointList: [], cache:
                        {
                            elements: {}, states: {}, stateElements: {}
                        },
                config:
                        {
                            breakpoints: {"*": {href: a, media: ""}}, containers: 1140, defaultState: c, events: {},
                            grid: {collapse: a, gutters: {vertical: 40, horizontal: 0}},
                            plugins: {}, pollOnce: a, preload: a, reset: Lt, RTL: a,
                            viewport: {width: "device-width"}
                        },
                css:
                        {
                            bm: "*,*:before,*:after{-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}",
                            n: 'html{font-family:sans-serif;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%}\n\
                        body{margin:0}article,\n\aside,details,figcaption,figure,footer,header,hgroup,main,nav,section,\n\
                        summary{display:block}audio,canvas,progress,video{display:inline-block;vertical-align:baseline}\n\
                        audio:not([controls]){display:none;height:0}[hidden],template{display:none}a{background:transparent}\n\
                        a:active,a:hover{outline:0}abbr[title]{border-bottom:1px dotted}b,strong{font-weight:bold}dfn{\n\
                        font-style:italic}h1{font-size:2em;margin:.67em 0}mark{background:#ff0;color:#000}small{font-size:80%}\n\
                        sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sup{top:-0.5em}\n\
                        sub{bottom:-0.25em}img{border:0}svg:not(:root){overflow:hidden}figure{margin:1em 40px}\n\
                        hr{-moz-box-sizing:content-box;box-sizing:content-box;height:0}pre{overflow:auto}code,kbd,pre,\n\
                        samp{font-family:monospace,monospace;font-size:1em}button,input,optgroup,select,textarea{color:inherit;\n\
                        font:inherit;margin:0}button{overflow:visible}button,select{text-transform:none}button,html\n\
                        input[type="button"],\n\input[type="reset"],input[type="submit"]{-webkit-appearance:button;\n\
                        cursor:pointer}button[disabled],\n\html input[disabled]{cursor:default}button::-moz-focus-inner,input::\n\
                        -moz-focus-inner{border:0;padding:0}\n\nput{line-height:normal}input[type="checkbox"],\n\
                        input[type="radio"]{box-sizing:border-box;padding:0}\n\input[type="number"]::-webkit-inner-spin-button,\n\
                        input[type="number"]::-webkit-outer-spin-button{\n\height:auto}\n\input[type="search"]{\n\
                        -webkit-appearance:textfield;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;\n\
                        box-sizing:content-box}input[type="search"]::-webkit-search-cancel-button,input[type="search"]::\n\
                        -webkit-search-decoration{\n\-webkit-appearance:none}fieldset{border:1px solid #c0c0c0;margin:0 2px;\n\
                        padding:.35em .625em .75em}legend{border:0;padding:0}textarea{overflow:auto}optgroup{font-weight:bold}\n\
                        table{border-collapse:collapse;border-spacing:0}td,th{padding:0}', r: "html,body,div,span,applet,object,\n\
                        iframe,h1,h2,h3,h4,h5,h6,p,blockquote,pre,a,abbr,acronym,address,big,cite,code,del,dfn,em,img,ins,\n\
                        ...
                        border:0;font-size:100%;font:inherit;vertical-align:baseline}article,aside,details,figcaption,figure,\n\
                        footer,header,hgroup,menu,nav,section{display:block}body{line-height:1}ol,ul{list-style:none}\n\
                ...
                defaults:
                        {
                            breakpoint:
                                    {
                                        config: c, elements: c, test: c
                                    },
                            config_breakpoint:
                                    {
                                        containers: "100%", grid: {}, href: a, media: "", viewport: {}
                                    }
                        },
                events: [], forceDefaultState: a, isInit: a, isStatic: a,
                locations:
                        {
                            body: c, head: c, html: c
                        },
                me: c, plugins: {}, sd: "/", stateId: "", vars: {}, DOMReady: c, getElementsByClassName: c,
                indexOf: c, isArray: c, iterate: c, matchesMedia: c,
                extend: function (e, t)
                {
                    var r;
                    Gt[n](t, function (n)
                    {
                        Gt[$](t[n]) ? (Gt[$](e[n]) || (e[n] = []), Gt[X](e[n], t[n])) :
                                typeof t[n] == b ? (typeof e[n] != b && (e[n] = {}), Gt[X](e[n], t[n])) : e[n] = t[n]
                    })
                },
                getArray: function (e)
                {
                ...
                isActive: function (e)
                {
                    ...
                    Gt[e].RTL && (Gt.unreverseRows(), u > 0 && Gt.reverseRows(u)), i = "_skel_cell_important_placeholder", r = Gt[s]("skel-cell-important"), r && r[f] > 0 && Gt[n](r, function (t) {
                        ...
                        if (u > 0 && c <= u) {
                            ...
                            n[rt](i) || (n[i] = a), o = n[i], o !== a && (n[l][p](n, o[Ht]), n[i] = a)
                    })
                    ...
                    Gt[n](t, function (n) {
                        if (n === f)
                            return;
                        var r = t[n];
                        if (r[B] || e > 0 && r[g][L](/\bcollapse-at-([0-9])\b/) && parseInt(RegExp.$1) >= e)
                            return;
                        var i = r.children, s;
                        for (s = 1; s < i[f]; s++)
                            r[p](i[s], i[0]);
                    ...
                    if (!Gt[H][vt][Gt[r]]) {
                        Gt[H][vt][Gt[r]] = {config: {}, elements: [], values: {}}, c = Gt[H][vt][Gt[r]], Gt[r] === Gt.sd ? u = [] : u = Gt[r][_](1).split(Gt.sd), Gt[X](c[e], Gt[it][x]), Gt[n](u, function (n) {
                            Gt[X](c[e], Gt[t][u[n]][e])
                        ...
                        c[i][d](g);
                        if (c[e][S][_t]) {
                            var ht = Gt.getLevel(c[e][S][_t]), pt, mt;
                            b = "iGC" + ht + "-" + c.values[I];
                            if (!(g = Gt[m](b))) {
                                T = ":not(.no-collapse)";
                                switch (ht) {
                    ...
                    if (Gt[Dt] && Gt[e].defaultState)
                        return Gt[e].defaultState;
                    var r = "";
                    ...
                    typeof r == b && (r[t] && (Gt[e][t] = {}), Gt[X](Gt[e], r)), S in Gt[e] && h in Gt[e][S] && typeof Gt[e][S][h] != b && (Gt[e][S][h] = {vertical: Gt[e][S][h], horizontal: Gt[e][S][h]}), Gt[X](Gt[it][x][S], Gt[e][S]), Gt[it][x][I] = Gt[e][I], Gt[n](Gt[e][t], function (n) {
                        ...
                        var e, t = document[u](F)[0], r = new XMLHttpRequest;
                        Gt[n](o, function (e) {
                    ...
                    document[Y] ? !function (e, t) {
                        ...
                        var t = [], n, r = document, i = ct, s = /^loaded|^c/.test(r[$t]);
                        ...
                        var n = [], r, i = !1, s = document, o = s[st], u = o.doScroll, a = ct, f = Y, l = "onreadystatechange", c = $t, h = u ? /^loaded|^c/ : /^loaded|c/, p = h.test(s[c]);
                        ...
                        if (e == "")
                            return D;
                        var t = document[k]("style"), n = document[u]("script")[0], r = c;
                        ...
                        n = e.split(/\s+and\s+/);
                        for (i in n)
                            t = n[i], t.charAt(0) == "(" && (t = t[_](1, t[f] - 1), r = t.split(/:\s+/), r[f] == 2 && (s[r[0][U](/^\s+|\s+$/g, "")] = parseInt(r[1]), o = D));
                        if (!o)
                            return a;
                        var u = document[st].clientWidth, l = document[st].clientHeight;
    ...
    return Gt.preInit(), Gt[q][ot] < 9 && (Gt[Nt] = function (e) {
    }, Gt[E] = function (e) {
        var t;
